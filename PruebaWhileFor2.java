/**
 * @File / Archivo: PruebaWhileFor2.java
 *
 ...
 * Usando la sentencia while sería: 
 */

public class PruebaWhileFor2
{
	/*
	...
	/**
	 * No hay otros atributos en esta Clase            PruebaWhileFor2
	 * There aren't anothers atributes on this Class
	 * */

	/**
	 * No hay otros métodos en esta Clase              PruebaWhileFor2
	 * There aren't anothers methods on this Class   
	 * */

	/**
	 * Método Principal de la Clase    PruebaWhileFor2    que contiene las sentencias que se van a ejecutar
